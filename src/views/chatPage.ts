...
<body>
  ...
  <script>
    ...
    async function markReminderSent(id) {
      try {
        await fetch("/api/reminders/" + encodeURIComponent(id) + "/mark-sent?userId=" + encodeURIComponent(userId), {
          method: "POST",
        });
    ...
    async function cancelReminder(id) {
      try {
        await fetch("/api/reminders/" + encodeURIComponent(id) + "/cancel?userId=" + encodeURIComponent(userId), {
          method: "POST",
        });
